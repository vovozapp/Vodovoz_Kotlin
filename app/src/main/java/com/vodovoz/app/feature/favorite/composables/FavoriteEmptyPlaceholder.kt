    ...
    Column(modifier = modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Column(
            ...
            Text(
                ...
                text = titleHtml.ifEmpty { stringResource(id = R.string.empty_favorite_list_message) },
            ...
            Text(
                modifier = Modifier.padding(top = 24.dp),
                text = descriptionHtml.ifEmpty { stringResource(id = R.string.add_to_favorites_message) },
