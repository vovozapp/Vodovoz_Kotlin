...
open class SwipeToRemoveCallback(mContext: Context) : ItemTouchHelper.Callback() {
    ...
    private val deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.deleteicon)!!
