...
class HomeNewViewModel(
    ...
    private val advertisingBannersSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    private val historiesSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    private val popularCategoriesSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    private val categoryBannersSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    private val discountProductsSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    private val topProductsSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    private val noveltiesProductsSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    ...
    private val bottomProductsSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    ...
    private val viewedProductsSliderUpdateSubject: PublishSubject<ViewState> = PublishSubject.create()
    ...
    init {
        Observable.zip(listOf(
            ...
            onNext = { viewState -> viewStateMLD.value = viewState},
            onError = { throwable ->
