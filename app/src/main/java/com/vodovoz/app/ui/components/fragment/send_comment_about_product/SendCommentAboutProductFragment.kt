package com.vodovoz.app.ui.components.fragment.send_comment_about_product
...
class SendCommentAboutProductFragment : ViewStateBaseBottomFragment() {

    private lateinit var binding: BottomFragmentSendCommentAboutProductBinding
    ...
    private fun getArgs() {
        viewModel.updateArgs(SendCommentAboutProductFragmentArgs.fromBundle(requireArguments()).productId)
    }

    override fun setContentView(
        inflater: LayoutInflater,
        container: ViewGroup
    ) = BottomFragmentSendCommentAboutProductBinding.inflate(
        inflater,
        container,
        false
