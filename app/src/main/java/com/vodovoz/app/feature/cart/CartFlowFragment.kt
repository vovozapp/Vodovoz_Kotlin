...
@AndroidEntryPoint
class CartFlowFragment : ViewStateBaseFragment() {

    companion object {
        const val GIFT_ID = "GIFT_ID"
    }

    private lateinit var binding: FragmentMainCartFlowBinding
    private val viewModel: CartViewModel by viewModels()

    private val bestForYouProductsSliderFragment: ProductsSliderFragment by lazy {
        ProductsSliderFragment.newInstance(
    ...
    override fun setContentView(
        ...
        container: ViewGroup
    ) = FragmentMainCartFlowBinding.inflate(
        inflater,
        container,
        false
    ...
    private fun initAvailableProductRecycler() {
        ...
        binding.btnChooseBottle.setOnClickListener { findNavController().navigate(
            CartFragmentDirections.actionToAllBottlesFragment()) }
