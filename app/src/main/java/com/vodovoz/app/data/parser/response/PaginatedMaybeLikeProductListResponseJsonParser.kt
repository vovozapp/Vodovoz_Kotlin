...
object PaginatedMaybeLikeProductListResponseJsonParser {

    fun ResponseBody.parsePaginatedMaybeLikeProductListResponse(): ResponseEntity<PaginatedProductListEntity> {
